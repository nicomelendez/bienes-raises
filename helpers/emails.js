    ...
    const transport = nodemailer.createTransport({
      ...
      await transport.sendMail({
        ...
        html:`
            ...
            <a href="${process.env.BACKEND_URL}:${process.env.PORT ?? 3002}/auth/confirmar/${token}">Confirmar cuenta</a> </p>
  ...
  const transport = nodemailer.createTransport({
    ...
    await transport.sendMail({
      ...
      html:`
          ...
          <a href="${process.env.BACKEND_URL}:${process.env.PORT ?? 3002}/auth/recuperar-password/${token}">Reestablecer contraseña</a> </p>
